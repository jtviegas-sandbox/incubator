	...
	grunt.initConfig({
        ...
        concat:{
			frontend: { src: [ 'src/frontend/js/*.js' ],
        			dest: 'dist/frontend/js/starling.js' },
			css: { src: [ 'src/frontend/css/base.css' ],
        			dest: 'dist/frontend/css/starling.css' } 
                },
		uglify: { build: { src: 'dist/frontend/js/starling.js',
        			dest: 'dist/frontend/js/starling.min.js' } },
