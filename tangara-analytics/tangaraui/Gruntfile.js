module.exports = function(grunt) {
	...
	grunt.initConfig({
        ...
        concat:{
			frontend: { src: [ 'src/frontend/js/libs/*.js', 'src/frontend/js/*.js' ],
        			dest: 'dist/frontend/js/tng.js' },
			css: { src: [ 'src/frontend/css/*.css' ],
        			dest: 'dist/frontend/css/tng.css' } 
                },
		uglify: { build: { src: 'dist/frontend/js/tng.js',
        			dest: 'dist/frontend/js/tng.min.js' } },
        copy: { main: { files: [ // includes files within path
                ...
                {flatten: true, expand: true, src: ['src/backend/img/*'], dest: 'dist/backend/img/'}
            ] } },
		watch: { uijsandcss: {
